...
namespace NOVAAPP.Pages.ListaPrecios
{
    public class IndexModel : PageModel
    {
        ...
        private readonly ICrudApi<ListaPreciosViewModel, int> service;

        [BindProperty(SupportsGet = true)]
        public ParametrosFiltros filtro { get; set; }

        [BindProperty]
        public ListaPreciosViewModel[] Objeto { get; set; }

        public IndexModel(ICrudApi<ListaPreciosViewModel, int> service)
        {
