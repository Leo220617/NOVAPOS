    ...
    try {
        ...
        for (var i = 0; i < Documento.Detalle.length; i++) {
            ...
            var Producto =
            {
                ...
                idProducto: PE.id,
                NumLinea: 0,
                Cantidad: parseFloat(Documento.Detalle[i].Cantidad),
                TotalImpuesto: parseFloat(Documento.Detalle[i].TotalImpuesto),
                PrecioUnitario: parseFloat(Documento.Detalle[i].PrecioUnitario),
                PorDescto: parseFloat(Documento.Detalle[i].PorDescto),
                Descuento: parseFloat(Documento.Detalle[i].Descuento),
                TotalLinea: parseFloat(Documento.Detalle[i].TotalLinea),
